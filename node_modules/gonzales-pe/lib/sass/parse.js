...
function checkArgument(i) {
  ...
  if (l = checkBrackets(i)) tokens[i].argument_child = 1;else if (l = checkParentheses(i)) tokens[i].argument_child = 2;else if (l = checkDeclaration(i)) tokens[i].argument_child = 3;else if (l = checkFunction(i)) tokens[i].argument_child = 4;else if (l = checkVariablesList(i)) tokens[i].argument_child = 5;else if (l = checkVariable(i)) tokens[i].argument_child = 6;else if (l = checkSC(i)) tokens[i].argument_child = 7;else if (l = checkDelim(i)) tokens[i].argument_child = 8;else if (l = checkDeclDelim(i)) tokens[i].argument_child = 9;else if (l = checkString(i)) tokens[i].argument_child = 10;else if (l = checkPercentage(i)) tokens[i].argument_child = 11;else if (l = checkDimension(i)) tokens[i].argument_child = 12;else if (l = checkNumber(i)) tokens[i].argument_child = 13;else if (l = checkUri(i)) tokens[i].argument_child = 14;else if (l = checkInterpolation(i)) tokens[i].argument_child = 15;else if (l = checkIdent(i)) tokens[i].argument_child = 16;else if (l = checkVhash(i)) tokens[i].argument_child = 17;else if (l = checkOperator(i)) tokens[i].argument_child = 18;else if (l = checkUnary(i)) tokens[i].argument_child = 19;
...
function checkAtrulers(i) {
  ...
  if (l = checkRuleset(i) || checkAtrule(i)) i += l;else return 0;
...
function getBlockdecl() {
  switch (tokens[pos].bd_type) {
    ...
    case 5:
      return getBlockdecl5();
    case 6:
      return getBlockdecl6();
    case 7:
      return getBlockdecl7();
  }
}
...
function getBlockdecl1() {
  ...
  while (pos < tokensLength) {
    ...
    if (checkS(pos)) _x.push(getS());else if (checkCommentSL(pos)) _x.push(getCommentSL());else {
      pos = _pos;
      break;
    }
  }
...
function getBlockdecl2() {
  ...
  while (pos < tokensLength) {
    if (checkS(pos)) x.push(getS());else if (checkCommentSL(pos)) x.push(getCommentSL());else break;
  }
...
function getBlockdecl5() {
  ...
  if (checkInclude(pos)) x.push(getInclude());else x.push(getRuleset());
...
function getBlockdecl6() {
  ...
  if (checkInclude(pos)) x = getInclude();else x = getRuleset();
...
function getInclude5() {
  var startPos = pos;
  var x = [].concat(getOperator(), getIdentOrInterpolation(), getSC(), getArguments(), getSC(), getBlock());
...
function getInclude6() {
  var startPos = pos;
  var x = [].concat(getOperator(), getIdentOrInterpolation(), getSC(), getArguments());
...
function getInclude7() {
  var startPos = pos;
  var x = [].concat(getOperator(), getIdentOrInterpolation(), getSC(), getBlock());
...
function getInclude8() {
  var startPos = pos;
  var x = [].concat(getOperator(), getIdentOrInterpolation());
...
function getMixin1() {
  ...
  if (checkBlock(pos)) x.push(getBlock());else {
...
function getStylesheet() {
  ...
  while (pos < tokensLength) {
    ...
    if (Array.isArray(node)) x = x.concat(node);else x.push(node);
  }
...
function _checkValue(i) {
  return checkVhash(i) || checkOperator(i) || checkImportant(i) || checkDefault(i) || checkProgid(i) || checkAny(i) || checkInterpolation(i);
}
